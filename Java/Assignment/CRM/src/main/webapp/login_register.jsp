      ...
      <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="index.jsp">Titan</a>
          </div>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Home</a>
                <ul class="dropdown-menu">
                  ...
                  <li><a href="index_portfolio.jsp">Portfolio</a></li>
                  ...
                  <li><a href="index_shop.jsp">Shop</a></li>
                </ul>
              </li>
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Headers</a>
                <ul class="dropdown-menu">
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Static Image Header</a>
                    <ul class="dropdown-menu">
                      <li><a href="index_mp_fullscreen_static.jsp">Fulscreen</a></li>
                      <li><a href="index_mp_classic_static.jsp">Classic</a></li>
                    </ul>
                  </li>
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Flexslider Header</a>
                    <ul class="dropdown-menu">
                      <li><a href="index_mp_fullscreen_flexslider.jsp">Fulscreen</a></li>
                      <li><a href="index_mp_classic_flexslider.jsp">Classic</a></li>
                    </ul>
                  </li>
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Video Background Header</a>
                    <ul class="dropdown-menu">
                      <li><a href="index_mp_fullscreen_video_background.jsp">Fulscreen</a></li>
                      <li><a href="index_mp_classic_video_background.jsp">Classic</a></li>
                    </ul>
                  </li>
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Text Rotator Header</a>
                    <ul class="dropdown-menu">
                      <li><a href="index_mp_fullscreen_text_rotator.jsp">Fulscreen</a></li>
                      <li><a href="index_mp_classic_text_rotator.jsp">Classic</a></li>
                    </ul>
                  </li>
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Pages</a>
                <ul class="dropdown-menu">
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">About</a>
                    <ul class="dropdown-menu">
                      <li><a href="about1.jsp">About 1</a></li>
                      <li><a href="about2.jsp">About 2</a></li>
                      <li><a href="about3.jsp">About 3</a></li>
                      <li><a href="about4.jsp">About 4</a></li>
                      <li><a href="about5.jsp">About 5</a></li>
                    </ul>
                  </li>
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Blog</a>
                <ul class="dropdown-menu" role="menu">
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Standard</a>
                    <ul class="dropdown-menu">
                      <li><a href="blog_standard_left_sidebar.jsp">Left Sidebar</a></li>
                      <li><a href="blog_standard_right_sidebar.jsp">Right Sidebar</a></li>
                    </ul>
                  </li>
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Grid</a>
                    <ul class="dropdown-menu">
                      <li><a href="blog_grid_col_2.jsp">2 Columns</a></li>
                      <li><a href="blog_grid_col_3.jsp">3 Columns</a></li>
                      <li><a href="blog_grid_col_4.jsp">4 Columns</a></li>
                    </ul>
                  </li>
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Masonry</a>
                    <ul class="dropdown-menu">
                      <li><a href="blog_grid_masonry_col_2.jsp">2 Columns</a></li>
                      <li><a href="blog_grid_masonry_col_3.jsp">3 Columns</a></li>
                      <li><a href="blog_grid_masonry_col_4.jsp">4 Columns</a></li>
                    </ul>
                  </li>
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Single</a>
                    <ul class="dropdown-menu">
                      <li><a href="blog_single_left_sidebar.jsp">Left Sidebar</a></li>
                      <li><a href="blog_single_right_sidebar.jsp">Right Sidebar</a></li>
                    </ul>
                  </li>
                </ul>
              </li>
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Features</a>
                <ul class="dropdown-menu" role="menu">
                  <li><a href="alerts-and-wells.jsp"><i class="fa fa-bolt"></i> Alerts and Wells</a></li>
                  <li><a href="buttons.jsp"><i class="fa fa-link fa-sm"></i> Buttons</a></li>
                  <li><a href="tabs_and_accordions.jsp"><i class="fa fa-tasks"></i> Tabs &amp; Accordions</a></li>
                  <li><a href="content_box.jsp"><i class="fa fa-list-alt"></i> Contents Box</a></li>
                  <li><a href="forms.jsp"><i class="fa fa-check-square-o"></i> Forms</a></li>
                  <li><a href="icons.jsp"><i class="fa fa-star"></i> Icons</a></li>
                  <li><a href="progress-bars.jsp"><i class="fa fa-server"></i> Progress Bars</a></li>
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Shop</a>
                <ul class="dropdown-menu" role="menu">
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Product</a>
                    <ul class="dropdown-menu">
                      <li><a href="shop_product_col_3.jsp">3 columns</a></li>
                      <li><a href="shop_product_col_4.jsp">4 columns</a></li>
                    </ul>
                  </li>
                  <li><a href="shop_single_product.jsp">Single Product</a></li>
                  <li><a href="shop_checkout.jsp">Checkout</a></li>
                </ul>
              </li>
            </ul>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-5">
                ...
                <form class="form" method="post" action="RegistrationController">
                  <div class="form-group">
                    <input class="form-control" id="E-mail" type="text" name="emailid" placeholder="Email"/>
                  </div>
                  <div class="form-group">
                    <input class="form-control" id="username" type="text" name="username" placeholder="Username"/>
                  </div>                  
