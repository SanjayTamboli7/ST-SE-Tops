...
<link
	href="assets/lib/owl.carousel/dist/assets/owl.theme.default.min.css" rel="stylesheet">
					...
					<div class="row">
						<div class="col-sm-6 col-md-8 col-lg-9">
							<div class="callout-text font-alt">
								<h4 style="margin-top: 0px;">Build successful business with world class CRM</h4>
								<p style="margin-bottom: 0px;">Apply this CRM today</p>
							</div>
						</div>						
					</div>
				</div>
