...
public class JTableSortingExample extends JFrame {
	...
	public List<Employee> createListEmployees() {
		...
		listEmployees.add(new Employee("Tanmay", "Manager", 40));
		listEmployees.add(new Employee("Prakash", "Programmer", 25));
		listEmployees.add(new Employee("Mahesh", "Designer", 25));
		listEmployees.add(new Employee("Paresh", "Leader", 30));
		listEmployees.add(new Employee("Trupesh", "Designer", 28));
		listEmployees.add(new Employee("Sanjay", "Analyst", 50));
		listEmployees.add(new Employee("Jawahar", "Programmer", 32));
		listEmployees.add(new Employee("Pankit", "Developer", 29));
		listEmployees.add(new Employee("Kamlesh", "Programmer", 23));
		listEmployees.add(new Employee("Anand", "Programmer", 23));
		listEmployees.add(new Employee("Jayesh", "Designer", 33));
		listEmployees.add(new Employee("Dalsukh", "Developer", 28));
		listEmployees.add(new Employee("Harish", "Designer", 31));
		listEmployees.add(new Employee("Chinmay", "Programmer", 26));
		listEmployees.add(new Employee("Jayesh", "Manager", 40));
