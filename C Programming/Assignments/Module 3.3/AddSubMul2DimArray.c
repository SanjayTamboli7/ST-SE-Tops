...
void main()
	{
		...
		printf("\n\t  \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2 Print values for Matrix 2 \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\n");
		for(i=0;i<3;i++)
			{
				printf("\n");
				for(j=0;j<3;j++)
		...
		printf("\n\t  \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2 Print Subtraction of Matrixs \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\n");
		for(i=0;i<3;i++)
			{
				printf("\n");
				for(j=0;j<3;j++)
		...
		printf("\n\t  \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2 Print Multiplication of Matrixs \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\n");
		for(i=0;i<3;i++)
			{
				printf("\n");
				for(j=0;j<3;j++)
